...
O Literalura é uma aplicação de console desenvolvida em Java 
com Spring Boot que permite a interação com a API Gutendex para criar um catálogo de livros personalizado.
O projeto foca em persistência de dados, consumo de APIs REST e organização lógica de informações.
...
Para rodar o projeto localmente, você precisará configurar o arquivo application.properties:
Ter o PostgreSQL instalado e rodando.
Criar um banco de dados chamado literalura.
Configurar as credenciais no arquivo de propriedades:
