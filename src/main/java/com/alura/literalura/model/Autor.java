...
public class Autor {
    ...
    // Construtor que recebe o DTO da API
    ...
    public String toString() {
        // Criamos uma lista apenas com os títulos para evitar erro de recursão
        ...
        return "\nNome: " + nome +
                ...
                "\nAno de Falecimento: " + (anoFalecimento != null ? anoFalecimento : "Vivo / N/A") +
                "\nLivros no Acervo: [" + titulosLivros + "]" +
                "\n---------------------------";
    }
}